...
#include <stdlib.h>
	...
	namespace g2Profiling {
		...
		void reset();
		void save(const char *filename = "E:\\ga\\progamming_sandbox\\libgasandbox\\e2ga.gp2", bool append = true);
		void init(const char *filename = "E:\\ga\\progamming_sandbox\\libgasandbox\\e2ga.gp2",
