	...
	*/
	...
	namespace {
		...
		void meetFromJoin_A1_B1_J2(const float *A, const float *B, const float *J, float *M) {
			M[0] = 1.0f * A[0] * B[1] * J[0] + 1.0f * A[0] * B[2] * J[1] + 1.0f * A[0] * B[3] * J[5] + -1.0f * A[1] * B[0] * J[0] + 1.0f * A[1] * B[2] * J[2] + 1.0f * A[1] * B[3] * J[3] + -1.0f * A[2] * B[0] * J[1] + -1.0f * A[2] * B[1] * J[2] + 1.0f * A[2] * B[3] * J[4] + -1.0f * A[3] * B[0] * J[5] + -1.0f * A[3] * B[1] * J[3] + -1.0f * A[3] * B[2] * J[4];
		}
		...
		void meetFromJoin_A2_B1_J2(const float *A, const float *B, const float *J, float *M) {
			M[0] = 1.0f * A[0] * B[0] * J[0] + -1.0f * A[0] * B[2] * J[2] + -1.0f * A[0] * B[3] * J[3] + 1.0f * A[1] * B[0] * J[1] + 1.0f * A[1] * B[1] * J[2] + -1.0f * A[1] * B[3] * J[4] + 1.0f * A[5] * B[0] * J[5] + 1.0f * A[5] * B[1] * J[3] + 1.0f * A[5] * B[2] * J[4];
			M[1] = 1.0f * A[0] * B[1] * J[0] + 1.0f * A[0] * B[2] * J[1] + 1.0f * A[0] * B[3] * J[5] + 1.0f * A[2] * B[0] * J[1] + 1.0f * A[2] * B[1] * J[2] + -1.0f * A[2] * B[3] * J[4] + 1.0f * A[3] * B[0] * J[5] + 1.0f * A[3] * B[1] * J[3] + 1.0f * A[3] * B[2] * J[4];
			M[2] = 1.0f * A[1] * B[1] * J[0] + 1.0f * A[1] * B[2] * J[1] + 1.0f * A[1] * B[3] * J[5] + -1.0f * A[2] * B[0] * J[0] + 1.0f * A[2] * B[2] * J[2] + 1.0f * A[2] * B[3] * J[3] + 1.0f * A[4] * B[0] * J[5] + 1.0f * A[4] * B[1] * J[3] + 1.0f * A[4] * B[2] * J[4];
			M[3] = -1.0f * A[3] * B[0] * J[0] + 1.0f * A[3] * B[2] * J[2] + 1.0f * A[3] * B[3] * J[3] + -1.0f * A[4] * B[0] * J[1] + -1.0f * A[4] * B[1] * J[2] + 1.0f * A[4] * B[3] * J[4] + 1.0f * A[5] * B[1] * J[0] + 1.0f * A[5] * B[2] * J[1] + 1.0f * A[5] * B[3] * J[5];
		}
		void meetFromJoin_A2_B1_J3(const float *A, const float *B, const float *J, float *M) {
			M[0] = 1.0f * A[0] * B[2] * J[3] + 1.0f * A[0] * B[3] * J[1] + -1.0f * A[1] * B[1] * J[3] + 1.0f * A[1] * B[3] * J[2] + 1.0f * A[2] * B[0] * J[3] + 1.0f * A[2] * B[3] * J[0] + 1.0f * A[3] * B[0] * J[1] + -1.0f * A[3] * B[2] * J[0] + 1.0f * A[4] * B[0] * J[2] + 1.0f * A[4] * B[1] * J[0] + -1.0f * A[5] * B[1] * J[1] + -1.0f * A[5] * B[2] * J[2];
		}
		...
		void meetFromJoin_A2_B2_J3(const float *A, const float *B, const float *J, float *M) {
			M[0] = 1.0f * A[0] * B[1] * J[3] + -1.0f * A[0] * B[4] * J[0] + 1.0f * A[0] * B[5] * J[1] + -1.0f * A[1] * B[0] * J[3] + 1.0f * A[1] * B[3] * J[0] + 1.0f * A[1] * B[5] * J[2] + -1.0f * A[5] * B[0] * J[1] + -1.0f * A[5] * B[1] * J[2] + -1.0f * A[5] * B[2] * J[0];
			M[1] = 1.0f * A[0] * B[2] * J[3] + 1.0f * A[0] * B[3] * J[1] + 1.0f * A[0] * B[4] * J[2] + -1.0f * A[2] * B[0] * J[3] + 1.0f * A[2] * B[3] * J[0] + 1.0f * A[2] * B[5] * J[2] + -1.0f * A[3] * B[0] * J[1] + -1.0f * A[3] * B[1] * J[2] + -1.0f * A[3] * B[2] * J[0];
			M[2] = 1.0f * A[1] * B[2] * J[3] + 1.0f * A[1] * B[3] * J[1] + 1.0f * A[1] * B[4] * J[2] + -1.0f * A[2] * B[1] * J[3] + 1.0f * A[2] * B[4] * J[0] + -1.0f * A[2] * B[5] * J[1] + -1.0f * A[4] * B[0] * J[1] + -1.0f * A[4] * B[1] * J[2] + -1.0f * A[4] * B[2] * J[0];
			M[3] = -1.0f * A[3] * B[1] * J[3] + 1.0f * A[3] * B[4] * J[0] + -1.0f * A[3] * B[5] * J[1] + 1.0f * A[4] * B[0] * J[3] + -1.0f * A[4] * B[3] * J[0] + -1.0f * A[4] * B[5] * J[2] + 1.0f * A[5] * B[2] * J[3] + 1.0f * A[5] * B[3] * J[1] + 1.0f * A[5] * B[4] * J[2];
		}
		void meetFromJoin_A2_B2_J4(const float *A, const float *B, const float *J, float *M) {
			M[0] = 1.0f * A[0] * B[4] * J[0] + -1.0f * A[1] * B[3] * J[0] + 1.0f * A[2] * B[5] * J[0] + -1.0f * A[3] * B[1] * J[0] + 1.0f * A[4] * B[0] * J[0] + 1.0f * A[5] * B[2] * J[0];
		}
		...
		void meetFromJoin_A3_B1_J2(const float *A, const float *B, const float *J, float *M) {
			M[0] = -1.0f * A[1] * B[0] * J[5] + -1.0f * A[1] * B[1] * J[3] + -1.0f * A[1] * B[2] * J[4] + -1.0f * A[3] * B[0] * J[1] + -1.0f * A[3] * B[1] * J[2] + 1.0f * A[3] * B[3] * J[4];
			M[1] = -1.0f * A[2] * B[0] * J[5] + -1.0f * A[2] * B[1] * J[3] + -1.0f * A[2] * B[2] * J[4] + 1.0f * A[3] * B[0] * J[0] + -1.0f * A[3] * B[2] * J[2] + -1.0f * A[3] * B[3] * J[3];
			M[2] = -1.0f * A[0] * B[0] * J[5] + -1.0f * A[0] * B[1] * J[3] + -1.0f * A[0] * B[2] * J[4] + 1.0f * A[3] * B[1] * J[0] + 1.0f * A[3] * B[2] * J[1] + 1.0f * A[3] * B[3] * J[5];
			M[3] = 1.0f * A[0] * B[0] * J[1] + 1.0f * A[0] * B[1] * J[2] + -1.0f * A[0] * B[3] * J[4] + 1.0f * A[1] * B[1] * J[0] + 1.0f * A[1] * B[2] * J[1] + 1.0f * A[1] * B[3] * J[5];
			M[4] = -1.0f * A[0] * B[0] * J[0] + 1.0f * A[0] * B[2] * J[2] + 1.0f * A[0] * B[3] * J[3] + 1.0f * A[2] * B[1] * J[0] + 1.0f * A[2] * B[2] * J[1] + 1.0f * A[2] * B[3] * J[5];
			M[5] = 1.0f * A[1] * B[0] * J[0] + -1.0f * A[1] * B[2] * J[2] + -1.0f * A[1] * B[3] * J[3] + 1.0f * A[2] * B[0] * J[1] + 1.0f * A[2] * B[1] * J[2] + -1.0f * A[2] * B[3] * J[4];
		}
		void meetFromJoin_A3_B1_J3(const float *A, const float *B, const float *J, float *M) {
			M[0] = 1.0f * A[1] * B[0] * J[1] + -1.0f * A[1] * B[2] * J[0] + 1.0f * A[2] * B[0] * J[2] + 1.0f * A[2] * B[1] * J[0] + 1.0f * A[3] * B[0] * J[3] + 1.0f * A[3] * B[3] * J[0];
			M[1] = 1.0f * A[0] * B[0] * J[2] + 1.0f * A[0] * B[1] * J[0] + 1.0f * A[1] * B[1] * J[1] + 1.0f * A[1] * B[2] * J[2] + 1.0f * A[3] * B[1] * J[3] + -1.0f * A[3] * B[3] * J[2];
			M[2] = -1.0f * A[0] * B[0] * J[1] + 1.0f * A[0] * B[2] * J[0] + 1.0f * A[2] * B[1] * J[1] + 1.0f * A[2] * B[2] * J[2] + 1.0f * A[3] * B[2] * J[3] + 1.0f * A[3] * B[3] * J[1];
			M[3] = 1.0f * A[0] * B[0] * J[3] + 1.0f * A[0] * B[3] * J[0] + 1.0f * A[1] * B[2] * J[3] + 1.0f * A[1] * B[3] * J[1] + -1.0f * A[2] * B[1] * J[3] + 1.0f * A[2] * B[3] * J[2];
		}
		void meetFromJoin_A3_B1_J4(const float *A, const float *B, const float *J, float *M) {
			M[0] = -1.0f * A[0] * B[0] * J[0] + -1.0f * A[1] * B[2] * J[0] + 1.0f * A[2] * B[1] * J[0] + 1.0f * A[3] * B[3] * J[0];
		}
		...
		void meetFromJoin_A3_B2_J3(const float *A, const float *B, const float *J, float *M) {
			M[0] = 1.0f * A[1] * B[0] * J[1] + 1.0f * A[1] * B[1] * J[2] + 1.0f * A[1] * B[2] * J[0] + 1.0f * A[3] * B[0] * J[3] + -1.0f * A[3] * B[3] * J[0] + -1.0f * A[3] * B[5] * J[2];
			M[1] = 1.0f * A[2] * B[0] * J[1] + 1.0f * A[2] * B[1] * J[2] + 1.0f * A[2] * B[2] * J[0] + 1.0f * A[3] * B[1] * J[3] + -1.0f * A[3] * B[4] * J[0] + 1.0f * A[3] * B[5] * J[1];
			M[2] = 1.0f * A[0] * B[0] * J[1] + 1.0f * A[0] * B[1] * J[2] + 1.0f * A[0] * B[2] * J[0] + 1.0f * A[3] * B[2] * J[3] + 1.0f * A[3] * B[3] * J[1] + 1.0f * A[3] * B[4] * J[2];
			M[3] = -1.0f * A[0] * B[0] * J[3] + 1.0f * A[0] * B[3] * J[0] + 1.0f * A[0] * B[5] * J[2] + 1.0f * A[1] * B[2] * J[3] + 1.0f * A[1] * B[3] * J[1] + 1.0f * A[1] * B[4] * J[2];
			M[4] = -1.0f * A[0] * B[1] * J[3] + 1.0f * A[0] * B[4] * J[0] + -1.0f * A[0] * B[5] * J[1] + 1.0f * A[2] * B[2] * J[3] + 1.0f * A[2] * B[3] * J[1] + 1.0f * A[2] * B[4] * J[2];
			M[5] = 1.0f * A[1] * B[1] * J[3] + -1.0f * A[1] * B[4] * J[0] + 1.0f * A[1] * B[5] * J[1] + -1.0f * A[2] * B[0] * J[3] + 1.0f * A[2] * B[3] * J[0] + 1.0f * A[2] * B[5] * J[2];
		}
		void meetFromJoin_A3_B2_J4(const float *A, const float *B, const float *J, float *M) {
			M[0] = -1.0f * A[1] * B[1] * J[0] + 1.0f * A[2] * B[0] * J[0] + 1.0f * A[3] * B[5] * J[0];
			M[1] = 1.0f * A[0] * B[0] * J[0] + -1.0f * A[1] * B[2] * J[0] + 1.0f * A[3] * B[3] * J[0];
			M[2] = 1.0f * A[0] * B[1] * J[0] + -1.0f * A[2] * B[2] * J[0] + 1.0f * A[3] * B[4] * J[0];
			M[3] = 1.0f * A[0] * B[5] * J[0] + 1.0f * A[1] * B[4] * J[0] + -1.0f * A[2] * B[3] * J[0];
		}
		...
		void meetFromJoin_A3_B3_J4(const float *A, const float *B, const float *J, float *M) {
			M[0] = -1.0f * A[1] * B[3] * J[0] + 1.0f * A[3] * B[1] * J[0];
			M[1] = -1.0f * A[2] * B[3] * J[0] + 1.0f * A[3] * B[2] * J[0];
			M[2] = -1.0f * A[0] * B[3] * J[0] + 1.0f * A[3] * B[0] * J[0];
			M[3] = -1.0f * A[0] * B[1] * J[0] + 1.0f * A[1] * B[0] * J[0];
			M[4] = -1.0f * A[0] * B[2] * J[0] + 1.0f * A[2] * B[0] * J[0];
			M[5] = 1.0f * A[1] * B[2] * J[0] + -1.0f * A[2] * B[1] * J[0];
		}
