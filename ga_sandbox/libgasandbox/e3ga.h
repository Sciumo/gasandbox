...
#include <stdlib.h>
	...
	inline __syn_smv___e1_e2_e3_e1e2e3 ___syn_smv___e1_e2_e3_e1e2e3(__syn_smv___e1_e2_e3_e1e2e3::Float arg1) {
		return __syn_smv___e1_e2_e3_e1e2e3(arg1);
	}
	...
	inline __syn_smv___e1e2f1_0 ___syn_smv___e1e2f1_0(__syn_smv___e1e2f1_0::Float arg1) {
		return __syn_smv___e1e2f1_0(arg1);
	}
	...
	inline __syn_smv___scalar_e1e2 ___syn_smv___scalar_e1e2(__syn_smv___scalar_e1e2::Float arg1) {
		return __syn_smv___scalar_e1e2(arg1);
	}
	...
	inline __syn_smv___e3f_1_0 ___syn_smv___e3f_1_0(__syn_smv___e3f_1_0::Float arg1) {
		return __syn_smv___e3f_1_0(arg1);
	}
	...
	inline __syn_smv___e1e3_e2e3 ___syn_smv___e1e3_e2e3(__syn_smv___e1e3_e2e3::Float arg1) {
		return __syn_smv___e1e3_e2e3(arg1);
	}
	...
	inline __syn_smv___scalar_e1e3_e2e3 ___syn_smv___scalar_e1e3_e2e3(__syn_smv___scalar_e1e3_e2e3::Float arg1) {
		return __syn_smv___scalar_e1e3_e2e3(arg1);
	}
	...
	inline __syn_smv___e1e2_e1e3_e2e3_e1e2e3 ___syn_smv___e1e2_e1e3_e2e3_e1e2e3(__syn_smv___e1e2_e1e3_e2e3_e1e2e3::Float arg1) {
		return __syn_smv___e1e2_e1e3_e2e3_e1e2e3(arg1);
	}
	...
	inline __syn_smv___e1e3f_1_0 ___syn_smv___e1e3f_1_0(__syn_smv___e1e3f_1_0::Float arg1) {
		return __syn_smv___e1e3f_1_0(arg1);
	}
	...
	inline __syn_smv___scalar_e1e3 ___syn_smv___scalar_e1e3(__syn_smv___scalar_e1e3::Float arg1) {
		return __syn_smv___scalar_e1e3(arg1);
	}
	...
	inline __syn_smv___e2e3f1_0 ___syn_smv___e2e3f1_0(__syn_smv___e2e3f1_0::Float arg1) {
		return __syn_smv___e2e3f1_0(arg1);
	}
	...
	inline __syn_smv___scalar_e2e3 ___syn_smv___scalar_e2e3(__syn_smv___scalar_e2e3::Float arg1) {
		return __syn_smv___scalar_e2e3(arg1);
	}
	...
	e2_t gp(const __e2_ct__& x, const scalar& y);
	vector negate(const vector& x);
	__syn_smv___e3f_1_0 negate(const __e3_ct__& x);
	trivector op(const bivector& x, const vector& y);
	scalar gp(const __syn_smv___e1e2& x, const __syn_smv___e1e2& y);
	bivector add(const bivector& x, const bivector& y);
	__syn_smv___e1e2 gp(const scalar& x, const __syn_smv___e1e2& y);
	__syn_smv___e1e3_e2e3 gp(const __syn_smv___e1e3_e2e3& x, const scalar& y);
	scalar norm_e(const bivector& x);
	scalar scp(const trivector& x, const trivector& y);
	bivector op(const vector& x, const vector& y);
	rotor gp(const rotor& x, const scalar& y);
	__syn_smv___e1_e2_e3_e1e2e3 gp(const rotor& x, const __e3_ct__& y);
	vector2D subtract(const e1_t& x, const e2_t& y);
	__syn_smv___e1_e2_e3_e1e2e3 gp(const __syn_smv___e1_e2_e3_e1e2e3& x, const rotor& y);
	__syn_smv___e2e3 gp(const scalar& x, const __syn_smv___e2e3f1_0& y);
	scalar norm_e(const vector& x);
	__syn_smv___e1e3f_1_0 lcont(const __e2_ct__& x, const __I3_ct__& y);
	__syn_smv___e1e3_e2e3 gp(const scalar& x, const __syn_smv___e1e3_e2e3& y);
	rotor gp(const __syn_smv___scalar_e1e3_e2e3& x, const rotor& y);
	bivector inverse(const bivector& x);
	__syn_smv___scalar_e1e3 add(const scalar& x, const __syn_smv___e1e3& y);
	rotor gp(const vector& x, const vector& y);
	e3_t gp(const __e3_ct__& x, const scalar& y);
	e1_t gp(const __e1_ct__& x, const scalar& y);
	vector gp(const vector& x, const scalar& y);
	vector gp(const scalar& x, const vector& y);
	__syn_smv___e1_e2_e3_e1e2e3 gp(const rotor& x, const vector& y);
	__syn_smv___e1e2 gp(const scalar& x, const __syn_smv___e1e2f1_0& y);
	scalar lcont(const vector& x, const vector& y);
	__syn_smv___e1e3_e2e3 op(const vector& x, const __e3_ct__& y);
	__syn_smv___e2e3f1_0 lcont(const __e1_ct__& x, const __I3_ct__& y);
	vector unit_e(const vector& x);
	__syn_smv___e1_e2_e3_e1e2e3 gp(const rotor& x, const __e1_ct__& y);
	vector inverse(const vector& x);
	__syn_smv___scalar_e1e3_e2e3 add(const scalar& x, const __syn_smv___e1e3_e2e3& y);
	scalar subtract(const scalar& x, const scalar& y);
	e1_t gp(const scalar& x, const __e1_ct__& y);
	rotor add(const scalar& x, const rotor& y);
	scalar norm_e2(const __syn_smv___scalar_e1e2& x);
	vector subtract(const vector& x, const vector& y);
	scalar norm_e2(const scalar& x);
	vector2D add(const e1_t& x, const e2_t& y);
	__syn_smv___e1e3 gp(const scalar& x, const __syn_smv___e1e3f_1_0& y);
	__syn_smv___scalar_e1e2 add(const scalar& x, const __syn_smv___e1e2& y);
	scalar norm_e2(const vector& x);
	rotor inverse(const rotor& x);
	__syn_smv___scalar_e2e3 add(const scalar& x, const __syn_smv___e2e3& y);
	rotor gp(const rotor& x, const rotor& y);
	__syn_smv___e1e2f1_0 op(const __e1_ct__& x, const __e2_ct__& y);
	__syn_smv___scalar_e1e2 gp(const __syn_smv___e1e3_e2e3& x, const __syn_smv___e1e3_e2e3& y);
	__syn_smv___e1_e2_e3_e1e2e3 gp(const rotor& x, const __e2_ct__& y);
	vector add(const vector& x, const vector& y);
	vector lcont(const vector& x, const bivector& y);
	__syn_smv___scalar_e1e2 subtract(const __syn_smv___scalar_e1e2& x, const scalar& y);
	bivector gp(const bivector& x, const scalar& y);
	scalar norm_e(const trivector& x);
	__syn_smv___e1e2_e1e3_e2e3_e1e2e3 add(const trivector& x, const bivector& y);
	trivector gp(const trivector& x, const scalar& y);
	e2_t gp(const scalar& x, const __e2_ct__& y);
	__syn_smv___e1e2 gp(const __syn_smv___e1e2& x, const scalar& y);
	scalar scp(const vector& x, const vector& y);
	trivector add(const trivector& x, const trivector& y);
	mv operator+=(mv& arg1, const mv& arg2);
	bivector operator+=(bivector& arg1, const bivector& arg2);
	scalar operator+=(scalar& arg1, const __syn_smv___e1e3& arg2);
	scalar operator+=(scalar& arg1, const __syn_smv___e1e3_e2e3& arg2);
	scalar operator+=(scalar& arg1, const rotor& arg2);
	e1_t operator+=(e1_t& arg1, const e2_t& arg2);
	scalar operator+=(scalar& arg1, const __syn_smv___e1e2& arg2);
	scalar operator+=(scalar& arg1, const __syn_smv___e2e3& arg2);
	vector operator+=(vector& arg1, const vector& arg2);
	trivector operator+=(trivector& arg1, const bivector& arg2);
	trivector operator+=(trivector& arg1, const trivector& arg2);
	...
	__syn_smv___e1_e2_e3_e1e2e3 operator+=(__syn_smv___e1_e2_e3_e1e2e3& arg1, const mv& arg2);
	__syn_smv___e1e2f1_0 operator+=(__syn_smv___e1e2f1_0& arg1, const mv& arg2);
	__syn_smv___e1e2 operator+=(__syn_smv___e1e2& arg1, const mv& arg2);
	__syn_smv___scalar_e1e2 operator+=(__syn_smv___scalar_e1e2& arg1, const mv& arg2);
	__syn_smv___e3f_1_0 operator+=(__syn_smv___e3f_1_0& arg1, const mv& arg2);
	__syn_smv___e1e3_e2e3 operator+=(__syn_smv___e1e3_e2e3& arg1, const mv& arg2);
	__syn_smv___scalar_e1e3_e2e3 operator+=(__syn_smv___scalar_e1e3_e2e3& arg1, const mv& arg2);
	__syn_smv___e1e2_e1e3_e2e3_e1e2e3 operator+=(__syn_smv___e1e2_e1e3_e2e3_e1e2e3& arg1, const mv& arg2);
	__syn_smv___e1e3f_1_0 operator+=(__syn_smv___e1e3f_1_0& arg1, const mv& arg2);
	__syn_smv___e1e3 operator+=(__syn_smv___e1e3& arg1, const mv& arg2);
	__syn_smv___scalar_e1e3 operator+=(__syn_smv___scalar_e1e3& arg1, const mv& arg2);
	__syn_smv___e2e3f1_0 operator+=(__syn_smv___e2e3f1_0& arg1, const mv& arg2);
	__syn_smv___e2e3 operator+=(__syn_smv___e2e3& arg1, const mv& arg2);
	__syn_smv___scalar_e2e3 operator+=(__syn_smv___scalar_e2e3& arg1, const mv& arg2);
	mv operator+(const mv& arg1, const mv& arg2);
	bivector operator+(const bivector& arg1, const bivector& arg2);
	__syn_smv___scalar_e1e3 operator+(const scalar& arg1, const __syn_smv___e1e3& arg2);
	__syn_smv___scalar_e1e3 operator+(float arg1, const __syn_smv___e1e3& arg2);
	__syn_smv___scalar_e1e3_e2e3 operator+(const scalar& arg1, const __syn_smv___e1e3_e2e3& arg2);
	__syn_smv___scalar_e1e3_e2e3 operator+(float arg1, const __syn_smv___e1e3_e2e3& arg2);
	rotor operator+(const scalar& arg1, const rotor& arg2);
	rotor operator+(float arg1, const rotor& arg2);
	vector2D operator+(const e1_t& arg1, const e2_t& arg2);
	__syn_smv___scalar_e1e2 operator+(const scalar& arg1, const __syn_smv___e1e2& arg2);
	__syn_smv___scalar_e1e2 operator+(float arg1, const __syn_smv___e1e2& arg2);
	__syn_smv___scalar_e2e3 operator+(const scalar& arg1, const __syn_smv___e2e3& arg2);
	__syn_smv___scalar_e2e3 operator+(float arg1, const __syn_smv___e2e3& arg2);
	vector operator+(const vector& arg1, const vector& arg2);
	__syn_smv___e1e2_e1e3_e2e3_e1e2e3 operator+(const trivector& arg1, const bivector& arg2);
	trivector operator+(const trivector& arg1, const trivector& arg2);
	mv operator-=(mv& arg1, const mv& arg2);
	e1_t operator-=(e1_t& arg1, const e2_t& arg2);
	scalar operator-=(scalar& arg1, const scalar& arg2);
	scalar operator-=(scalar& arg1, float arg2);
	vector operator-=(vector& arg1, const vector& arg2);
	__syn_smv___scalar_e1e2 operator-=(__syn_smv___scalar_e1e2& arg1, const scalar& arg2);
	__syn_smv___scalar_e1e2 operator-=(__syn_smv___scalar_e1e2& arg1, float arg2);
	e2_t operator-=(e2_t& arg1, const mv& arg2);
	e3_t operator-=(e3_t& arg1, const mv& arg2);
	vector2D operator-=(vector2D& arg1, const mv& arg2);
	...
	mv operator-(const mv& arg1, const mv& arg2);
	vector2D operator-(const e1_t& arg1, const e2_t& arg2);
	scalar operator-(const scalar& arg1, const scalar& arg2);
	scalar operator-(float arg1, const scalar& arg2);
	scalar operator-(const scalar& arg1, float arg2);
	vector operator-(const vector& arg1, const vector& arg2);
	__syn_smv___scalar_e1e2 operator-(const __syn_smv___scalar_e1e2& arg1, const scalar& arg2);
	__syn_smv___scalar_e1e2 operator-(const __syn_smv___scalar_e1e2& arg1, float arg2);
	mv operator-(const mv& arg1);
	vector operator-(const vector& arg1);
	__syn_smv___e3f_1_0 operator-(const __e3_ct__& arg1);
	mv operator%=(mv& arg1, const mv& arg2);
	trivector operator%=(trivector& arg1, const trivector& arg2);
	vector operator%=(vector& arg1, const vector& arg2);
	...
	scalar operator%(const trivector& arg1, const trivector& arg2);
	scalar operator%(const vector& arg1, const vector& arg2);
	mv operator^=(mv& arg1, const mv& arg2);
	bivector operator^=(bivector& arg1, const vector& arg2);
	vector operator^=(vector& arg1, const vector& arg2);
	vector operator^=(vector& arg1, const __e3_ct__& arg2);
	__e1_ct__ operator^=(__e1_ct__& arg1, const __e2_ct__& arg2);
	e1_t operator^=(e1_t& arg1, const mv& arg2);
	e2_t operator^=(e2_t& arg1, const mv& arg2);
	e3_t operator^=(e3_t& arg1, const mv& arg2);
	scalar operator^=(scalar& arg1, const mv& arg2);
	...
	__syn_smv___scalar_e2e3 operator^=(__syn_smv___scalar_e2e3& arg1, const mv& arg2);
	mv operator^(const mv& arg1, const mv& arg2);
	trivector operator^(const bivector& arg1, const vector& arg2);
	bivector operator^(const vector& arg1, const vector& arg2);
	__syn_smv___e1e3_e2e3 operator^(const vector& arg1, const __e3_ct__& arg2);
	__syn_smv___e1e2f1_0 operator^(const __e1_ct__& arg1, const __e2_ct__& arg2);
	mv operator*=(mv& arg1, const mv& arg2);
	__e2_ct__ operator*=(__e2_ct__& arg1, const scalar& arg2);
	__e2_ct__ operator*=(__e2_ct__& arg1, float arg2);
	__syn_smv___e1e2 operator*=(__syn_smv___e1e2& arg1, const __syn_smv___e1e2& arg2);
	scalar operator*=(scalar& arg1, const __syn_smv___e1e2& arg2);
	__syn_smv___e1e3_e2e3 operator*=(__syn_smv___e1e3_e2e3& arg1, const scalar& arg2);
	__syn_smv___e1e3_e2e3 operator*=(__syn_smv___e1e3_e2e3& arg1, float arg2);
	rotor operator*=(rotor& arg1, const scalar& arg2);
	rotor operator*=(rotor& arg1, float arg2);
	rotor operator*=(rotor& arg1, const __e3_ct__& arg2);
	__syn_smv___e1_e2_e3_e1e2e3 operator*=(__syn_smv___e1_e2_e3_e1e2e3& arg1, const rotor& arg2);
	scalar operator*=(scalar& arg1, const __syn_smv___e2e3f1_0& arg2);
	scalar operator*=(scalar& arg1, const __syn_smv___e1e3_e2e3& arg2);
	__syn_smv___scalar_e1e3_e2e3 operator*=(__syn_smv___scalar_e1e3_e2e3& arg1, const rotor& arg2);
	vector operator*=(vector& arg1, const vector& arg2);
	__e3_ct__ operator*=(__e3_ct__& arg1, const scalar& arg2);
	__e3_ct__ operator*=(__e3_ct__& arg1, float arg2);
	__e1_ct__ operator*=(__e1_ct__& arg1, const scalar& arg2);
	__e1_ct__ operator*=(__e1_ct__& arg1, float arg2);
	vector operator*=(vector& arg1, const scalar& arg2);
	vector operator*=(vector& arg1, float arg2);
	scalar operator*=(scalar& arg1, const vector& arg2);
	rotor operator*=(rotor& arg1, const vector& arg2);
	scalar operator*=(scalar& arg1, const __syn_smv___e1e2f1_0& arg2);
	rotor operator*=(rotor& arg1, const __e1_ct__& arg2);
	scalar operator*=(scalar& arg1, const __e1_ct__& arg2);
	scalar operator*=(scalar& arg1, const __syn_smv___e1e3f_1_0& arg2);
	rotor operator*=(rotor& arg1, const rotor& arg2);
	__syn_smv___e1e3_e2e3 operator*=(__syn_smv___e1e3_e2e3& arg1, const __syn_smv___e1e3_e2e3& arg2);
	rotor operator*=(rotor& arg1, const __e2_ct__& arg2);
	bivector operator*=(bivector& arg1, const scalar& arg2);
	bivector operator*=(bivector& arg1, float arg2);
	trivector operator*=(trivector& arg1, const scalar& arg2);
	trivector operator*=(trivector& arg1, float arg2);
	scalar operator*=(scalar& arg1, const __e2_ct__& arg2);
	__syn_smv___e1e2 operator*=(__syn_smv___e1e2& arg1, const scalar& arg2);
	__syn_smv___e1e2 operator*=(__syn_smv___e1e2& arg1, float arg2);
	e1_t operator*=(e1_t& arg1, const mv& arg2);
	e2_t operator*=(e2_t& arg1, const mv& arg2);
	e3_t operator*=(e3_t& arg1, const mv& arg2);
	vector2D operator*=(vector2D& arg1, const mv& arg2);
	...
	__syn_smv___scalar_e2e3 operator*=(__syn_smv___scalar_e2e3& arg1, const mv& arg2);
	mv operator*(const mv& arg1, const mv& arg2);
	e2_t operator*(const __e2_ct__& arg1, const scalar& arg2);
	e2_t operator*(const __e2_ct__& arg1, float arg2);
	scalar operator*(const __syn_smv___e1e2& arg1, const __syn_smv___e1e2& arg2);
	__syn_smv___e1e2 operator*(const scalar& arg1, const __syn_smv___e1e2& arg2);
	__syn_smv___e1e2 operator*(float arg1, const __syn_smv___e1e2& arg2);
	__syn_smv___e1e3_e2e3 operator*(const __syn_smv___e1e3_e2e3& arg1, const scalar& arg2);
	__syn_smv___e1e3_e2e3 operator*(const __syn_smv___e1e3_e2e3& arg1, float arg2);
	rotor operator*(const rotor& arg1, const scalar& arg2);
	rotor operator*(const rotor& arg1, float arg2);
	__syn_smv___e1_e2_e3_e1e2e3 operator*(const rotor& arg1, const __e3_ct__& arg2);
	__syn_smv___e1_e2_e3_e1e2e3 operator*(const __syn_smv___e1_e2_e3_e1e2e3& arg1, const rotor& arg2);
	__syn_smv___e2e3 operator*(const scalar& arg1, const __syn_smv___e2e3f1_0& arg2);
	__syn_smv___e2e3 operator*(float arg1, const __syn_smv___e2e3f1_0& arg2);
	__syn_smv___e1e3_e2e3 operator*(const scalar& arg1, const __syn_smv___e1e3_e2e3& arg2);
	__syn_smv___e1e3_e2e3 operator*(float arg1, const __syn_smv___e1e3_e2e3& arg2);
	rotor operator*(const __syn_smv___scalar_e1e3_e2e3& arg1, const rotor& arg2);
	rotor operator*(const vector& arg1, const vector& arg2);
	e3_t operator*(const __e3_ct__& arg1, const scalar& arg2);
	e3_t operator*(const __e3_ct__& arg1, float arg2);
	e1_t operator*(const __e1_ct__& arg1, const scalar& arg2);
	e1_t operator*(const __e1_ct__& arg1, float arg2);
	vector operator*(const vector& arg1, const scalar& arg2);
	vector operator*(const vector& arg1, float arg2);
	vector operator*(const scalar& arg1, const vector& arg2);
	vector operator*(float arg1, const vector& arg2);
	__syn_smv___e1_e2_e3_e1e2e3 operator*(const rotor& arg1, const vector& arg2);
	__syn_smv___e1e2 operator*(const scalar& arg1, const __syn_smv___e1e2f1_0& arg2);
	__syn_smv___e1e2 operator*(float arg1, const __syn_smv___e1e2f1_0& arg2);
	__syn_smv___e1_e2_e3_e1e2e3 operator*(const rotor& arg1, const __e1_ct__& arg2);
	e1_t operator*(const scalar& arg1, const __e1_ct__& arg2);
	e1_t operator*(float arg1, const __e1_ct__& arg2);
	__syn_smv___e1e3 operator*(const scalar& arg1, const __syn_smv___e1e3f_1_0& arg2);
	__syn_smv___e1e3 operator*(float arg1, const __syn_smv___e1e3f_1_0& arg2);
	rotor operator*(const rotor& arg1, const rotor& arg2);
	__syn_smv___scalar_e1e2 operator*(const __syn_smv___e1e3_e2e3& arg1, const __syn_smv___e1e3_e2e3& arg2);
	__syn_smv___e1_e2_e3_e1e2e3 operator*(const rotor& arg1, const __e2_ct__& arg2);
	bivector operator*(const bivector& arg1, const scalar& arg2);
	bivector operator*(const bivector& arg1, float arg2);
	trivector operator*(const trivector& arg1, const scalar& arg2);
	trivector operator*(const trivector& arg1, float arg2);
	e2_t operator*(const scalar& arg1, const __e2_ct__& arg2);
	e2_t operator*(float arg1, const __e2_ct__& arg2);
	__syn_smv___e1e2 operator*(const __syn_smv___e1e2& arg1, const scalar& arg2);
	__syn_smv___e1e2 operator*(const __syn_smv___e1e2& arg1, float arg2);
	mv operator<<=(mv& arg1, const mv& arg2);
	__e2_ct__ operator<<=(__e2_ct__& arg1, const __I3_ct__& arg2);
	vector operator<<=(vector& arg1, const vector& arg2);
	__e1_ct__ operator<<=(__e1_ct__& arg1, const __I3_ct__& arg2);
	vector operator<<=(vector& arg1, const bivector& arg2);
	e1_t operator<<=(e1_t& arg1, const mv& arg2);
	e2_t operator<<=(e2_t& arg1, const mv& arg2);
	e3_t operator<<=(e3_t& arg1, const mv& arg2);
	scalar operator<<=(scalar& arg1, const mv& arg2);
	...
	__syn_smv___scalar_e2e3 operator<<=(__syn_smv___scalar_e2e3& arg1, const mv& arg2);
	mv operator<<(const mv& arg1, const mv& arg2);
	__syn_smv___e1e3f_1_0 operator<<(const __e2_ct__& arg1, const __I3_ct__& arg2);
	scalar operator<<(const vector& arg1, const vector& arg2);
	__syn_smv___e2e3f1_0 operator<<(const __e1_ct__& arg1, const __I3_ct__& arg2);
	vector operator<<(const vector& arg1, const bivector& arg2);
	mv operator*(const mv& arg1);
	mv operator!(const mv& arg1);
	bivector operator!(const bivector& arg1);
	vector operator!(const vector& arg1);
	...
	inline mv lcont(const mv& x, const mv& y) {
		...
		if (((x.m_gu & 2) != 0)) {
			...
			if (((y.m_gu & 2) != 0)) {
				__tmp_coord_array_1__[0] += ((__x_xpd__[1][0] * __y_xpd__[1][0]) + (__x_xpd__[1][1] * __y_xpd__[1][1]) + (__x_xpd__[1][2] * __y_xpd__[1][2]));
	...
	inline scalar scp(const mv& x, const mv& y) {
		...
		if (((x.m_gu & 4) != 0)) {
			if (((y.m_gu & 4) != 0)) {
				__temp_var_1__.m_c[0] += ((-1.0f * __x_xpd__[2][1] * __y_xpd__[2][1]) + (-1.0f * __x_xpd__[2][2] * __y_xpd__[2][2]) + (-1.0f * __x_xpd__[2][0] * __y_xpd__[2][0]));
	...
	inline scalar extract_coord(const mv& x, const mv& y) {
		...
		if (((y.m_gu & 4) != 0)) {
			if (((x.m_gu & 4) != 0)) {
				__temp_var_1__.m_c[0] += ((__x_xpd__[2][0] * __y_xpd__[2][0]) + (__x_xpd__[2][2] * __y_xpd__[2][2]) + (__x_xpd__[2][1] * __y_xpd__[2][1]));
	...
	inline mv gp(const mv& x, const mv& y) {
		...
		if (((y.m_gu & 2) != 0)) {
			...
			if (((x.m_gu & 4) != 0)) {
				...
				__tmp_coord_array_2__[3] += ((__x_xpd__[2][2] * __y_xpd__[1][0]) + (-1.0f * __x_xpd__[2][1] * __y_xpd__[1][1]));
		...
		if (((y.m_gu & 4) != 0)) {
			...
			if (((x.m_gu & 4) != 0)) {
				__tmp_coord_array_2__[0] += ((-1.0f * __x_xpd__[2][2] * __y_xpd__[2][2]) + (-1.0f * __x_xpd__[2][1] * __y_xpd__[2][1]) + (-1.0f * __x_xpd__[2][0] * __y_xpd__[2][0]));
	...
	inline mv op(const mv& x, const mv& y) {
		...
		if (((x.m_gu & 4) != 0)) {
			...
			if (((y.m_gu & 2) != 0)) {
				__tmp_coord_array_3__[7] += ((__x_xpd__[2][1] * __y_xpd__[1][0]) + (__x_xpd__[2][2] * __y_xpd__[1][1]) + (__x_xpd__[2][0] * __y_xpd__[1][2]));
	...
	inline scalar norm_e(const mv& x) {
		...
		if (((x.m_gu & 2) != 0)) {
			e2.m_c[0] += ((__x_xpd__[1][1] * __x_xpd__[1][1]) + (__x_xpd__[1][2] * __x_xpd__[1][2]) + (__x_xpd__[1][0] * __x_xpd__[1][0]));
	...
	inline scalar norm_r(const mv& x) {
		...
		if (((x.m_gu & 4) != 0)) {
			r2.m_c[0] += ((__x_xpd__[2][2] * __x_xpd__[2][2]) + (__x_xpd__[2][0] * __x_xpd__[2][0]) + (__x_xpd__[2][1] * __x_xpd__[2][1]));
	...
	inline mv unit_r(const mv& x) {
		...
		if (((x.m_gu & 4) != 0)) {
			r2.m_c[0] += ((__x_xpd__[2][2] * __x_xpd__[2][2]) + (__x_xpd__[2][1] * __x_xpd__[2][1]) + (__x_xpd__[2][0] * __x_xpd__[2][0]));
	...
	inline mv inverse(const mv& x) {
		...
		if (((x.m_gu & 4) != 0)) {
			n.m_c[0] += ((__x_xpd__[2][1] * __x_xpd__[2][1]) + (__x_xpd__[2][0] * __x_xpd__[2][0]) + (__x_xpd__[2][2] * __x_xpd__[2][2]));
	...
	inline mv apply_om(const om& x, const mv& y) {
		...
		y.expand(__y_xpd__, true);
		if (((y.m_gu & 2) != 0)) {
			__tmp_coord_array_13__[1] += ((x.m_c[2] * __y_xpd__[1][2]) + (x.m_c[0] * __y_xpd__[1][0]) + (x.m_c[1] * __y_xpd__[1][1]));
		...
		if (((y.m_gu & 4) != 0)) {
			__tmp_coord_array_13__[4] += ((x.m_c[9] * __y_xpd__[2][0]) + (x.m_c[10] * __y_xpd__[2][1]) + (x.m_c[11] * __y_xpd__[2][2]));
			__tmp_coord_array_13__[5] += ((x.m_c[12] * __y_xpd__[2][0]) + (x.m_c[13] * __y_xpd__[2][1]) + (x.m_c[14] * __y_xpd__[2][2]));
			__tmp_coord_array_13__[6] += ((x.m_c[17] * __y_xpd__[2][2]) + (x.m_c[15] * __y_xpd__[2][0]) + (x.m_c[16] * __y_xpd__[2][1]));
	...
	namespace __G2_GENERATED__ {
		inline void set(om& __x__, const vector& __image_of_e1__, const vector& __image_of_e2__, const vector& __image_of_e3__) {
			...
			__x__.m_c[9] = ((__x__.m_c[4] * __x__.m_c[0]) + (-1.0f * __x__.m_c[1] * __x__.m_c[3]));
	...
	inline bivector add(const bivector& x, const bivector& y) {
		return bivector(bivector_e1e2_e2e3_e3e1, (y.m_c[0] + x.m_c[0]), (x.m_c[1] + y.m_c[1]), (y.m_c[2] + x.m_c[2]));
	}
	...
	inline __syn_smv___e1_e2_e3_e1e2e3 gp(const __syn_smv___e1_e2_e3_e1e2e3& x, const rotor& y) {
		return __syn_smv___e1_e2_e3_e1e2e3(__syn_smv___e1_e2_e3_e1e2e3_e1_e2_e3_e1e2e3, ((x.m_c[2] * y.m_c[3]) + (-1.0f * x.m_c[3] * y.m_c[2]) + (-1.0f * x.m_c[1] * y.m_c[1]) + (x.m_c[0] * y.m_c[0])), ((x.m_c[0] * y.m_c[1]) + (-1.0f * x.m_c[2] * y.m_c[2]) + (x.m_c[1] * y.m_c[0]) + (-1.0f * x.m_c[3] * y.m_c[3])), ((x.m_c[2] * y.m_c[0]) + (-1.0f * x.m_c[3] * y.m_c[1]) + (x.m_c[1] * y.m_c[2]) + (-1.0f * x.m_c[0] * y.m_c[3])), ((x.m_c[1] * y.m_c[3]) + (x.m_c[0] * y.m_c[2]) + (x.m_c[3] * y.m_c[0]) + (x.m_c[2] * y.m_c[1])));
	}
	...
	inline rotor gp(const __syn_smv___scalar_e1e3_e2e3& x, const rotor& y) {
		return rotor(rotor_scalar_e1e2_e2e3_e3e1, ((x.m_c[1] * y.m_c[3]) + (-1.0f * x.m_c[2] * y.m_c[2]) + (x.m_c[0] * y.m_c[0])), ((-1.0f * x.m_c[1] * y.m_c[2]) + (x.m_c[0] * y.m_c[1]) + (-1.0f * x.m_c[2] * y.m_c[3])), ((x.m_c[0] * y.m_c[2]) + (x.m_c[2] * y.m_c[0]) + (x.m_c[1] * y.m_c[1])), ((x.m_c[2] * y.m_c[1]) + (x.m_c[0] * y.m_c[3]) + (-1.0f * x.m_c[1] * y.m_c[0])));
	}
	...
	inline __syn_smv___e1_e2_e3_e1e2e3 gp(const rotor& x, const vector& y) {
		return __syn_smv___e1_e2_e3_e1e2e3(__syn_smv___e1_e2_e3_e1e2e3_e1_e2_e3_e1e2e3, ((-1.0f * x.m_c[3] * y.m_c[2]) + (x.m_c[1] * y.m_c[1]) + (x.m_c[0] * y.m_c[0])), ((x.m_c[0] * y.m_c[1]) + (-1.0f * x.m_c[1] * y.m_c[0]) + (x.m_c[2] * y.m_c[2])), ((x.m_c[0] * y.m_c[2]) + (x.m_c[3] * y.m_c[0]) + (-1.0f * x.m_c[2] * y.m_c[1])), ((x.m_c[2] * y.m_c[0]) + (x.m_c[3] * y.m_c[1]) + (x.m_c[1] * y.m_c[2])));
	}
	...
	inline rotor inverse(const rotor& x) {
		scalar n;
		n.m_c[0] = ((x.m_c[0] * x.m_c[0]) + (x.m_c[2] * x.m_c[2]) + (x.m_c[3] * x.m_c[3]) + (x.m_c[1] * x.m_c[1]));
		scalar in;
		in.m_c[0] = ((char)1 / n.m_c[0]);
	...
	inline rotor gp(const rotor& x, const rotor& y) {
		return rotor(rotor_scalar_e1e2_e2e3_e3e1, ((x.m_c[0] * y.m_c[0]) + (-1.0f * x.m_c[2] * y.m_c[2]) + (-1.0f * x.m_c[3] * y.m_c[3]) + (-1.0f * x.m_c[1] * y.m_c[1])), ((-1.0f * x.m_c[2] * y.m_c[3]) + (x.m_c[3] * y.m_c[2]) + (x.m_c[0] * y.m_c[1]) + (x.m_c[1] * y.m_c[0])), ((x.m_c[2] * y.m_c[0]) + (x.m_c[0] * y.m_c[2]) + (x.m_c[1] * y.m_c[3]) + (-1.0f * x.m_c[3] * y.m_c[1])), ((x.m_c[0] * y.m_c[3]) + (-1.0f * x.m_c[1] * y.m_c[2]) + (x.m_c[2] * y.m_c[1]) + (x.m_c[3] * y.m_c[0])));
	}
