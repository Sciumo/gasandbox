...
// Generated on 2007-01-08 14:15:41 by G2 0.1 from 'E:\ga\ga_sandbox\ga_sandbox\libgasandbox\e2ga.gs2'
...
#include <stdlib.h> /* required to save profile */
	...
	namespace g2Profiling {
		namespace { // anonymous namespace for profiling code:
			...
			const char *g_functionNames[] = {
				...
				"", // 0 
					...
					"void set(om __x__, vector __image_of_e1__, vector __image_of_e2__)", // 20 
					// function names for underscore constructors for specialized types
					"__NON_G2__ _e1_t(mv arg1)", // 21 
					"__NON_G2__ _e2_t(mv arg1)", // 22 
					"__NON_G2__ _scalar(mv arg1)", // 23 
					"__NON_G2__ _vector(mv arg1)", // 24 
					"__NON_G2__ _bivector(mv arg1)", // 25 
					"__NON_G2__ _rotor(mv arg1)", // 26 
					"__NON_G2__ ___e1_ct__(mv arg1)", // 27 
					"__NON_G2__ ___e2_ct__(mv arg1)", // 28 
					"__NON_G2__ ___I2_ct__(mv arg1)", // 29 
					"__NON_G2__ ___I2i_ct__(mv arg1)", // 30 
					// function names for underscore constructors for floats
					"__NON_G2__ _float(mv arg1)", // 31 
					"__NON_G2__ _double(mv arg1)", // 32 
					"__NON_G2__ _Float(mv arg1)", // 33 
					""
			};
			...
			bool g_usedTypes[] = {false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false};
		...
		void init(const char *gp2Filename /*= "E:\\ga\\ga_sandbox\\ga_sandbox\\libgasandbox\\e2ga.gp2"*/,
			...
			{ // send opening message:
				const char *gs2Filename = "E:\\ga\\ga_sandbox\\ga_sandbox\\libgasandbox\\e2ga.gs2";
				...
				{
					int bufIdx = 0;
					unsigned short nbFunctionsIds = 10;
					bufIdx += g2Net::serialize_ushort(forReal, buf, bufIdx, nbFunctionsIds);
					n = g2Net::sendN(g_profileNetSocket, buf, bufIdx);
				}
